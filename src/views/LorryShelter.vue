...
export default defineComponent({
  ...
  mounted() {
    ...
    let building = BABYLON.SceneLoader.ImportMesh('', './models/buildings/lorry-shelter/', 'lorry-shelter.gltf', scene, (meshes) => {
      meshes[0].scaling = new BABYLON.Vector3(this.zoomFactor * this.length / 10, this.zoomFactor * this.height / this.heightOffset, this.zoomFactor * this.width / this.widthOffset)
    ...
    let truck = BABYLON.SceneLoader.ImportMesh('', './models/truck/', 'truck.gltf', scene, (meshes) => {
      meshes[0].scaling = new BABYLON.Vector3(1, 0.9, 1)
      // meshes[0].position.y = 0
      meshes[0].position.x = this.zoomFactor * this.length / 350
    })
  ...
  methods: {
    ...
    dimensionChange(val, dir) {
      ...
      this.rootMesh.scaling = new BABYLON.Vector3(this.zoomFactor * this.length / 10, this.zoomFactor * this.height / this.heightOffset, this.zoomFactor * this.width / this.widthOffset)
