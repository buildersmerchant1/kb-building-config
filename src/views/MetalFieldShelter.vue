<template>
  <div class="relative w-full h-full">
    <div class="menus-area" :class="!fullscreen ? 'top-[50px] lg:top-[100px]' : 'top-[40px]'">
      <primary-button icon="camera" @click="submenu('snapshot')" :active="submenus.snapshot" class="ml-auto" />
...
export default defineComponent({
  ...
  mounted() {
    ...
    let building = BABYLON.SceneLoader.ImportMesh('', './models/buildings/metal-field-shelter/', 'metal-field-shelter.gltf', scene, (meshes) => {
