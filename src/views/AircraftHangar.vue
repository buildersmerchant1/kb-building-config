<template>
  <div class="relative w-full h-full">
    ...
    <div v-if="submenus.len" class="overflow-hidden flex py-3 absolute inset-x-0 z-50 bg-white menus-scroller-container pl-14 mr-auto animate-top" :class="!fullscreen ? 'animate-top-large' : 'animate-top-small'">
...
export default defineComponent({
  ...
  mounted() {
    ...
    let building = BABYLON.SceneLoader.ImportMesh('', './models/buildings/aircraft-hangar/', 'aircraft-hangar.gltf', scene, (meshes) => {
    ...
    let airplane = BABYLON.SceneLoader.ImportMesh('', './models/airplane/', 'airplane.gltf', scene, (meshes) => {
      // meshes[0].scaling = new BABYLON.Vector3(0.45, 0.45, 0.45)
