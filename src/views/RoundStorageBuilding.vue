...
export default defineComponent({
  ...
  data() {
    return {
      ...
      doorsNumbers: {
        main: { front: 1, back: 0 },
        personnel: { front: 1, back: 0 },
      },
      mainDoors: ['Winch Operated Steel Frame PVC Door', 'Automatic Metal Roller Shutter'],
  ...
  mounted() {
    ...
    let building = BABYLON.SceneLoader.ImportMesh('', './models/buildings/round-storage-building/', 'round-storage-building.gltf', scene, (meshes) => {
