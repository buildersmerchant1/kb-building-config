...
var prepareShaderMaterialUniforms = function(gltfRuntime, shaderMaterial, technique, material, unTreatedUniforms) {
  ...
  var _loop_1 = function(unif2) {
    ...
    if (type === EParameterType.SAMPLER_2D) {
      ...
      if (uniform.value && GLTFUtils.SetUniform(shaderMaterial, unif2, material.values ? value : uniform.value, type)) {
...
var GLTFLoader = function() {
  ...
  GLTFLoader3.prototype._importMeshAsync = function(meshesNames, scene, data, rootUrl, assetContainer, onSuccess, onProgress, onError) {
    var _this = this;
  ...
  GLTFLoader3.prototype.importMeshAsync = function(meshesNames, scene, assetContainer, data, rootUrl, onProgress) {
    var _this = this;
    return new Promise(function(resolve, reject) {
  ...
  GLTFLoader3.prototype._loadAsync = function(scene, data, rootUrl, onSuccess, onProgress, onError) {
    var _this = this;
    scene.useRightHandedSystem = true;
    GLTFLoaderExtension.LoadRuntimeAsync(scene, data, rootUrl, function(gltfRuntime) {
  ...
  GLTFLoader3.prototype._loadBuffersAsync = function(gltfRuntime, onLoad) {
...
var GLTFLoader2 = function() {
  ...
  GLTFLoader3.prototype.importMeshAsync = function(meshesNames, scene, container, data, rootUrl, onProgress, fileName) {
    var _this = this;
    if (fileName === void 0) {
      fileName = "";
    }
  ...
  GLTFLoader3.prototype._loadAsync = function(rootUrl, fileName, nodes, resultFunc) {
    var _this = this;
    return Promise.resolve().then(function() {
  ...
  GLTFLoader3.prototype._loadExtensions = function() {
    for (var name_1 in GLTFLoader3._RegisteredExtensions) {
      var extension = GLTFLoader3._RegisteredExtensions[name_1].factory(this);
  ...
  GLTFLoader3.prototype._loadSkinAsync = function(context, node, skin, assign) {
    var _this = this;
  ...
  GLTFLoader3.prototype._findSkeletonRootNode = function(context, joints) {
    if (joints.length === 0) {
      return null;
    }
    var paths = {};
    ...
    return this._loadAnimationSamplerAsync("".concat(animationContext, "/samplers/").concat(channel.sampler), sampler).then(function(data) {
      ...
      switch (data.interpolation) {
        case "STEP": {
          getNextKey = function(frameIndex2) {
            return {
              frame: data.input[frameIndex2] * _this.parent.targetFps,
      ...
      if (targetPath === "influence") {
        var _loop_2 = function(targetIndex2) {
          var animationName2 = "".concat(babylonAnimationGroup.name, "_channel").concat(babylonAnimationGroup.targetedAnimations.length);
          var babylonAnimation2 = new Animation(animationName2, targetPath, _this.parent.targetFps, animationType);
  ...
  GLTFLoader3.prototype.loadBufferAsync = function(context, buffer, byteOffset, byteLength) {
    ...
    if (accessor.sparse) {
      ...
      accessor._data = accessor._data.then(function(data) {
        ...
        return Promise.all([
          ...
          var indices = GLTFLoader3._GetTypedArray("".concat(context, "/sparse/indices"), sparse_1.indices.componentType, indicesData, sparse_1.indices.byteOffset, sparse_1.count);
          var sparseLength = numComponents * sparse_1.count;
          var values;
          if (accessor.componentType === 5126 && !accessor.normalized) {
            values = GLTFLoader3._GetTypedArray("".concat(context, "/sparse/values"), accessor.componentType, valuesData, sparse_1.values.byteOffset, sparseLength);
          } else {
            var sparseData = GLTFLoader3._GetTypedArray("".concat(context, "/sparse/values"), accessor.componentType, valuesData, sparse_1.values.byteOffset, sparseLength);
  ...
  GLTFLoader3.prototype._loadIndicesAccessorAsync = function(context, accessor) {
    ...
    if (accessor.sparse) {
      var constructor = GLTFLoader3._GetTypedArrayConstructor("".concat(context, "/componentType"), accessor.componentType);
  ...
  GLTFLoader3.prototype._loadVertexBufferViewAsync = function(bufferView) {
  ...
  GLTFLoader3.prototype._loadTextureAsync = function(context, texture, assign) {
    ...
    var sampler = texture.sampler == void 0 ? GLTFLoader3.DefaultSampler : ArrayItem.Get("".concat(context, "/sampler"), this._gltf.samplers, texture.sampler);
  ...
  GLTFLoader3.prototype._createTextureAsync = function(context, sampler, image, assign, textureLoaderOptions, useSRGBBuffer) {
    var _this = this;
    if (assign === void 0) {
      assign = function() {
      };
  ...
  GLTFLoader3.prototype._loadSampler = function(context, sampler) {
    if (!sampler._data) {
      sampler._data = {
        ...
        wrapU: GLTFLoader3._GetTextureWrapMode("".concat(context, "/wrapS"), sampler.wrapS),
        wrapV: GLTFLoader3._GetTextureWrapMode("".concat(context, "/wrapT"), sampler.wrapT)
      };
    }
    return sampler._data;
  };
  ...
  GLTFLoader3._GetTypedArray = function(context, componentType, bufferView, byteOffset, length) {
    ...
    var constructor = GLTFLoader3._GetTypedArrayConstructor("".concat(context, "/componentType"), componentType);
...
var EXT_meshopt_compression = function() {
  ...
  EXT_meshopt_compression2.prototype.loadBufferViewAsync = function(context, bufferView) {
    var _this = this;
    return GLTFLoader2.LoadExtensionAsync(context, bufferView, this.name, function(extensionContext, extension) {
...
var EXT_texture_webp = function() {
  ...
  EXT_texture_webp2.prototype._loadTextureAsync = function(context, texture, assign) {
    ...
    return GLTFLoader2.LoadExtensionAsync(context, texture, this.name, function(extensionContext, extension) {
      var sampler = texture.sampler == void 0 ? GLTFLoader2.DefaultSampler : ArrayItem.Get("".concat(context, "/sampler"), _this._loader.gltf.samplers, texture.sampler);
...
var KHR_materials_variants = function() {
  ...
  KHR_materials_variants2.SelectVariant = function(rootMesh, variantName) {
    var extensionMetadata = this._GetExtensionMetadata(rootMesh);
    if (!extensionMetadata) {
      throw new Error("Cannot select variant on a glTF mesh that does not have the ".concat(NAME15, " extension"));
    }
  ...
  KHR_materials_variants2.Reset = function(rootMesh) {
    var extensionMetadata = this._GetExtensionMetadata(rootMesh);
    if (!extensionMetadata) {
      throw new Error("Cannot reset on a glTF mesh that does not have the ".concat(NAME15, " extension"));
    }
  ...
  KHR_materials_variants2.GetLastSelectedVariant = function(rootMesh) {
    var extensionMetadata = this._GetExtensionMetadata(rootMesh);
    if (!extensionMetadata) {
      throw new Error("Cannot get the last selected variant on a glTF mesh that does not have the ".concat(NAME15, " extension"));
    }
    ...
    return GLTFLoader2.LoadExtensionAsync(context, primitive, this.name, function(extensionContext, extension) {
      ...
      promises.push(_this._loader._loadMeshPrimitiveAsync(context, name, node, mesh, primitive, function(babylonMesh) {
        ...
        if (babylonMesh instanceof Mesh) {
          ...
          var gltf = metadata.gltf = metadata.gltf || {};
          var extensionMetadata_1 = gltf[NAME15] = gltf[NAME15] || { lastSelected: null, original: [], variants: {} };
          ...
          var _loop_1 = function(mappingIndex2) {
            ...
            var material = ArrayItem.Get("".concat(extensionContext, "/mappings/").concat(mappingIndex2, "/material"), _this._loader.gltf.materials, mapping.material);
            promises.push(_this._loader._loadMaterialAsync("#/materials/".concat(mapping.material), material, babylonMesh, babylonDrawMode, function(babylonMaterial) {
              var _loop_2 = function(mappingVariantIndex2) {
                ...
                var variant = ArrayItem.Get("/extensions/".concat(NAME15, "/variants/").concat(variantIndex), _this._variants, variantIndex);
    ...
    return GLTFLoader2.LoadExtensionAsync(context, node, this.name, function(extensionContext, extension) {
      ...
      return _this._loader.loadNodeAsync(extensionContext, node, function(babylonMesh) {
        var _loop_1 = function(emitterIndex2) {
          var emitter = ArrayItem.Get("".concat(extensionContext, "/emitters"), _this._emitters, emitterIndex2);
...
GLTFLoader2.RegisterExtension(NAME23, function(loader) {
...
GLTFLoader2.RegisterExtension(NAME27, function(loader) {
...
var SolidParser = function() {
  ...
  SolidParser2.prototype._setDataForCurrentFaceWithPattern1 = function(face, v) {
    ...
    for (var k = 0; k < this._triangles.length; k++) {
      ...
      this._setData(indicePositionFromObj, 0, 0, this._positions[indicePositionFromObj], Vector2.Zero(), Vector3.Up(), this._loadingOptions.importVertexColors ? this._colors[indicePositionFromObj] : void 0);
    }
    this._triangles = [];
  };
  SolidParser2.prototype._setDataForCurrentFaceWithPattern2 = function(face, v) {
    ...
    for (var k = 0; k < this._triangles.length; k++) {
      ...
      this._setData(indicePositionFromObj, indiceUvsFromObj, 0, this._positions[indicePositionFromObj], this._uvs[indiceUvsFromObj], Vector3.Up(), this._loadingOptions.importVertexColors ? this._colors[indicePositionFromObj] : void 0);
    }
    this._triangles = [];
  };
  ...
  SolidParser2.prototype._setDataForCurrentFaceWithPattern4 = function(face, v) {
    ...
    for (var k = 0; k < this._triangles.length; k++) {
      ...
      this._setData(indicePositionFromObj, 1, indiceNormalFromObj, this._positions[indicePositionFromObj], Vector2.Zero(), this._normals[indiceNormalFromObj], this._loadingOptions.importVertexColors ? this._colors[indicePositionFromObj] : void 0);
    }
    this._triangles = [];
  };
  SolidParser2.prototype._setDataForCurrentFaceWithPattern5 = function(face, v) {
    ...
    for (var k = 0; k < this._triangles.length; k++) {
      ...
      this._setData(indicePositionFromObj, indiceUvsFromObj, indiceNormalFromObj, this._positions[indicePositionFromObj], this._uvs[indiceUvsFromObj], this._normals[indiceNormalFromObj], this._loadingOptions.importVertexColors ? this._colors[indicePositionFromObj] : void 0);
    }
    this._triangles = [];
  };
